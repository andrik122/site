...
$products_list = array(
    0 => array(
        'product_id' => '1520',    //код товара 2 (из каталога CRM)
        'price'      => '799', //цена товара 2
...
<head>
    ...
    <title>ВІТАЄМО! Ваше замовлення!</title>
...
<script>
  ...
  fbq('init', '842912050944187');
  fbq('track', 'PageView');
  fbq('track', 'Lead');
  fbq('track', 'Purchase');
</script>
<noscript><img height="1" width="1" style="display:none"
  src="https://www.facebook.com/tr?id=842912050944187&ev=PageView&noscript=1"
/></noscript>
